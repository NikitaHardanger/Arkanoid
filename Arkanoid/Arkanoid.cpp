...
public:
    Sprite background, background1, background2, background3, background4, nameGame, buttonPlay, settings, exit, changeTheme, hints, buttonBack, buttonLevel[8],
        levels, player, ball, buttonStart, block[1000], butBack_in_play, blockBlack, win, restart, nextlevel, buttonMenu, life[3], 
        endgame, theme1, theme2, theme3, theme4, lineTheme,
